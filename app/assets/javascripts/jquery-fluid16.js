...
Toggle : function(){
	...
	$.each(
		["grid", "paragraphs", "blockquote", "activity-items", "data-items","section-menu", "tables", "forms", "login-forms", "search", "articles", "accordion"],
		function() {
...
Kwicks : function(){
    ...
    $("#kwick .kwick")
        .bind("mouseenter", function(e) {
            ...
            animating == true;
            $("#kwick .kwick").not(this).animate({ "width": "10%" }, 200);
            $(this).animate({ "width": "70%" }, 200, function() {
                animating = false;
            });
        });
